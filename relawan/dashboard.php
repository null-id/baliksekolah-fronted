          ...
          <div class="well">
            ...
            <div class="row">
              ...
              <div class="col-xs-8 col-md-10">
                <h2>Nama <small>(Username)</small></h2>
                <p>Email</p>
                <p>Alamat</p>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="panel panel-default">
          <div class="panel-heading">Statistik Saya</div>
          <div class="panel-body">
            <ul class="list-group">
              <li class="list-group-item">Anak Yang Didata
              <span class="pull-right text-muted small"><em>xx</em></span>
              </li>
              <li class="list-group-item">Terverifikasi
              <span class="pull-right text-muted small"><em>xx</em></span>
              </li>
              <li class="list-group-item">Belum Diverifikasi
              <span class="pull-right text-muted small"><em>xx</em></span>
              </li>
              <li class="list-group-item">Sudah Ditindak Lanjut
              <span class="pull-right text-muted small"><em>xx</em></span>
              </li>
            </ul>
          </div>
      ...
      <div class="col-md-6">
        <div class="panel panel-default">
          <div class="panel-heading">Statistik Keseluruhan</div>
          <div class="panel-body">
            <ul class="list-group">
              <li class="list-group-item">Anak Yang Didata
              <span class="pull-right text-muted small"><em>xx</em></span>
